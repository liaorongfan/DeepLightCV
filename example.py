...
def get_parser():
    ...
    parser.add_argument("--train_data", help="train data", default="./datasets/face_recognition/train", type=str)
    parser.add_argument("--test_data", help="test data", default="./datasets/face_recognition/val", type=str)

...
from basetrainer.models.light_model.MobileNet.mobilenetv1 import mbv1
from basetrainer.models.light_model.MobileNet.mobilenetv2 import mbv2
from basetrainer.models.light_model.MobileNet.mobilenetv3 import mbv3_small as mbv3
...
def get_models(net_type, input_size, num_classes, width_mult=1.0, is_train=True, pretrained=True, **kwargs):
    ...
    elif net_type.lower() == "mobilenet_v1":
        model = mbv1(num_classes=num_classes)
    elif net_type.lower() == "mobilenet_v2":
        model = mbv2(num_classes=num_classes)
    elif net_type.lower() == "mobilenet_v3":
        model = mbv3(num_classes=num_classes)
    else:
